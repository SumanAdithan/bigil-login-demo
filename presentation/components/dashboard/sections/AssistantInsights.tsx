...
export const AssistantInsights = () => {
    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className='flex-216 rounded-[12px] bg-[#003460] bg-[radial-gradient(circle_at_top_left,rgba(78,170,232,0.3)_0%,transparent_20%),radial-gradient(circle_at_bottom_right,rgba(78,170,232,0.3)_0%,transparent_20%)] p-2 shadow-sm'>
            ...
            <div className='flex-650 flex flex-col gap-6 bg-white rounded-[12px] shadow-sm'>
                <div className='flex-1 flex flex-col gap-3 rounded-[12px] p-5'>
                ...
                <div className='flex-1 rounded-[12px] p-5'>
