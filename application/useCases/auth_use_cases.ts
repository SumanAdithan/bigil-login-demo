...
export const authUseCases = {
    loginWithImd: async (data: ImdLoginData) => {
        ...
        return { success: result.success, redirectTo: '/login/otp' };
    },
    ...
    generateOtp: async (data: ForgotPasswordData) => {
        ...
        return { success: result.success, redirectTo: '/login/otp', state: { recovery: true } };
    },
    ...
    verifyOtp: async (otp: string, isRecovery: boolean) => {
        ...
        const redirectTo = isRecovery ? '/login/reset-password' : '/';
    ...
    resetPassword: async (data: ResetPasswordData) => {
        ...
        return { success: result.success, redirectTo: '/login/reset-success' };
    }
};
